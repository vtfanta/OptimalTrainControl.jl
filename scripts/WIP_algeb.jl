...
updateEs_cb = FunctionCallingCallback(make_update_Es(0., V); funcat = tstops[tstops .> 0.], func_start = false)

callbacks = CallbackSet(lowspeed_cb, targetspeed_cb, updateEs_cb, saving_cb, powercoast_cb)
